...
function initWebGL(canvas, debug) {
  let gl = WebGLUtils.setupWebGL2(canvas);
...
/**
  * Create a program object given shader ids
  * @param gl WebGL context
  * @param vertexShaderID - ID of the vertexShader script
  * @param fragmentShaderID - ID of the fragmentShader script
  * @return created program object; null if failed
  */
function createProgram(gl, vertexShaderID, fragmentShaderID) {
  // functions from utils/webgl-init
